...
class Graphe(Singleton):
    ...
    def init(self, fichierImport=None):
        ...
        if fichierImport != None:
            self.importer(fichierImport)
    ...
    def importer(self, fichierImport):
        ...
        try:
            ...
            todo: self.__dico.update(pickle.load(fichier))
            fichier.close()
    ...
    def exporter(self, fichierExport):
        ...
        try:
            fichier = open(fichierExport, 'bw')  # creer le fichier
        except:
...
if __name__ == '__main__':
    ...
    a.afficher()
    try:
        a.remplacerAttributsSommet('a', ('er', 15))
    except Exception:
        print('OK')
